...
function setupEventListeners() {
    ...
    document.getElementById('pedidoClienteForm').addEventListener('submit', handlePedidoCliente);
...
function renderProductos(productosToRender) {
    ...
    productosToRender.forEach(producto => {
        ...
        menuItem.innerHTML = `
            <img src="${producto.imagen || 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=400'}" alt="${producto.nombre}">
...
async function handleConfirmarPedido() {
    ...
    try {
        ...
        const pedidoData = {
            ...
            mesa_id: clienteData.mesa_id,
            mesero_id: 1, // Default mesero for demo
            estado: 'pendiente'
        };
